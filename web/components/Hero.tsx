    ...
    <section id="hero" className="flex flex-col px-4 pt-12 pb-10 text-center md:pt-16 md:pb-12 min-h-[500px]">
      <div className="mx-auto max-w-5xl relative z-10 w-full">
        <h1 className="mb-4 text-4xl font-black tracking-tight sm:text-5xl md:mb-6 md:text-7xl lg:text-8xl font-mono">
          <span className="text-white">Latestx</span>{" "}
          ...
          <div className="w-full max-w-2xl">
            <div dir="ltr" data-orientation="horizontal">
              ...
              <div
                ...
                className="relative text-gray-400 items-center justify-center rounded-lg bg-white/5 border border-primary/20 mb-6 grid w-full grid-cols-3 p-1.5 h-11"
              >
                {/* Animated sliding indicator */}
                <div
                  className="absolute top-1.5 bottom-1.5 rounded-md bg-primary/20 border border-primary/30 shadow transition-all duration-300 ease-out"
                  style={{
                ...
                {tabs.map((tab, i) => (
                  <button
                    ...
                    className={`relative z-10 inline-flex items-center justify-center rounded-md px-3 py-1.5 text-sm whitespace-nowrap font-medium transition-colors duration-200 font-mono ${activeTab === tab
